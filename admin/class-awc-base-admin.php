...
class Awc_Base_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Awc_Base_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Awc_Base_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/awc-base-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/awc-base-admin.js', array( 'jquery' ), $this->version, false );
	...
	public function add_plugin_admin_menu() {
		...
		add_menu_page( 'PAGE WHAT??????', 'Settings Page Title', 'manage_options', 'partials/' . $this->plugin_name . '-options', [ $this, 'display_plugin_option_page' ], '', 30);
		add_submenu_page( 'partials/' . $this->plugin_name . '-options', 'Plugin Settings Page Title', 'Submenu Title', 'manage_options', $this->plugin_name, array($this, 'display_plugin_setup_page')
		);
	...
	public function display_plugin_option_page() {
		...
		include_once( 'partials/' . $this->plugin_name . '-options.php' );
